...
function NewCard() {
    ...
    return (
        <div className='wh-200px border rounded d-flex justify-content-center align-items-center p-4 m-3'>
            ...
            {modalState == true ? <CardCreate modalState={modalState} changeModalState={changeModalState} /> : null}
        </div>
    )
}
